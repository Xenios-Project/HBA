            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries mx-auto">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img">
                            <img src="../assets/img/BAF-Logo.jpeg" alt="" class="img-fluid">
                        </div>

                        <h2 class="entry-title" data-tag="announcement-article-3-1">></h2>

                        <div class="entry-meta">
                            <ul>
                                <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="../blog-single.html" data-tag="announcement-2"></a></li>
                                <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="../blog-single.html"><time datetime="2020-01-01" data-tag="announcement-article-3-2"></time></a></li>
                            </ul>
                        </div>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="../assets/img/baf-img-2.jpeg" alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="../assets/img/baf-img-1.jpeg" alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="../assets/img/baf-img-3.jpeg" alt="Third slide">
                                    </div>
                                </div>
