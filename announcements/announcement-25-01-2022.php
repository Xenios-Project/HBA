            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries mx-auto">
                    ...
                    <article class="entry entry-single">
                        ...
                        <h2 class="entry-title" data-tag="announcement-article-4-1">></h2>

                        <div class="entry-meta">
                            <ul>
                                <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="../blog-single.html" data-tag="announcement-2"></a></li>
                                <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="../blog-single.html"><time datetime="2020-01-01" data-tag="announcement-article-4-2"></time></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="entry-content">
                            ...
                            <p data-tag="announcement-article-4-4"></p>
                            <img id="img-fluid" alt="BAF Summit" src="../assets/img/baf-2-img-3.jpeg"/>
                        </div>
